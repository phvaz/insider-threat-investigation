...
The consolidated sequence, rendered visually (attacker actions in coral, system-recorded events in teal, investigator action in blue). The full interactive version is available in [`forensic-timeline.html`](forensic-timeline.html).
